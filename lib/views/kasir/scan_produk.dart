  ...
  Future<void> checkProduct(String barcode) async {
    ...
    try {
      ...
      if (querySnapshot.docs.isEmpty) {
        ...
        setState(() {
          scannedProduct = Product.fromScannedProduct(
              product); // Menggunakan factory constructor
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          color:
                              scannedProduct != null ? primaryBlue : errorRed,
                        ),
                      ),
                          ...
                          if (scannedProduct != null)
                            Expanded(
                              child: ElevatedButton(
                                onPressed: () {
                                  if (scannedProduct != null &&
                                      widget.onProductScanned != null) {
                                    widget.onProductScanned!(scannedProduct!);
                                    // Tampilkan pesan sukses
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                            '${scannedProduct!.name} ditambahkan ke keranjang'),
