...
import 'package:si_kasir/views/kasir/daftar_produk.dart'; // Import DaftarProdukScreen
...
class _CreateProdukScreenState extends State<CreateProdukScreen> {
  ...
  void _navigateToDaftarProduk() {
    // Navigate to the product list screen and replace current screen
  ...
  Future<void> _saveProduct() async {
    ...
    final String hargaBeli = _hargaBeliController.text
        .replaceAll('.', '')
        .trim(); // Hapus tanda pemisah ribuan
    final String hargaJual = _hargaJualController.text
        .replaceAll('.', '')
        .trim(); // Hapus tanda pemisah ribuan
    ...
    try {
      ...
      // Navigate to product list screen after successful save
      _navigateToDaftarProduk();
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
