...
class _UpdateProdukScreenState extends State<UpdateProdukScreen> {
      ...
      if (docSnapshot.exists) {
        ...
        setState(() {
          ...
          _hargaBeliController.text =
              _formatCurrency(data['hargaBeli'].toString());
          _hargaJualController.text =
              _formatCurrency(data['hargaJual'].toString());
          ...
          if (imagePath != null && !imagePath.startsWith('http')) {
            _existingImageUrl =
                'https://res.cloudinary.com/dlu5vj2x6/image/upload/$imagePath';
          } else {
  ...
  Future<void> _updateProduct() async {
    ...
    final String hargaBeli =
        _hargaBeliController.text.replaceAll('.', '').trim();
    final String hargaJual =
        _hargaJualController.text.replaceAll('.', '').trim();
