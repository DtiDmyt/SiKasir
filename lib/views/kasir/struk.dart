                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            _buildInfoRow(
                                'Tanggal',
                                _formatDateTime(transactionData!['timestamp']
                                    as Timestamp)),
                            _buildInfoRow(
                                'Metode Pembayaran',
                                transactionData!['paymentMethod'] == 'langsung'
                                    ? 'Tunai'
                            ...
                            if (transactionData!['paymentMethod'] ==
                                'piutang') ...[
                              _buildInfoRow('Nama Pembeli',
                                  transactionData!['customerName']),
                              _buildInfoRow(
                                  'Pembayaran Awal',
                                  _formatCurrency(
                                      transactionData!['initialPayment'])),
                              _buildInfoRow(
                                  'Sisa Hutang',
                                  _formatCurrency(
                                      transactionData!['remainingDebt'])),
                            ],

                            const Divider(height: 40, color: Colors.grey),

                            // Order Items
                            ...(transactionData!['products'] as List)
                                .map(
