...
class TransactionDetail {
  ...
  factory TransactionDetail.fromDocument(DocumentSnapshot doc) {
    ...
    final formattedDate =
        DateFormat('dd MMM yyyy', 'id_ID').format(transactionDate);
...
class DetailTunaiScreen extends StatefulWidget {
  final String transactionId;

  const DetailTunaiScreen({
    Key? key,
    required this.transactionId,
  }) : super(key: key);

  @override
  _DetailTunaiScreenState createState() => _DetailTunaiScreenState();
}

class _DetailTunaiScreenState extends State<DetailTunaiScreen> {
